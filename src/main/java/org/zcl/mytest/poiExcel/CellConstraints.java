...
public class CellConstraints {
	...
	public CellConstraints(ExcelWriteContext context,String sheetName,int startRow,int startColumn){
	...
	public CellConstraints setFont(String fontName, int size, boolean bold, boolean italic, boolean underLine, boolean deleteLine){
		CellStyle style=context.cloneCellStyle(sheetName, startRow, startColumn);
	...
	public CellConstraints mergeTo(int endRow, int endColumn){
		...
		context.getWorkSheet(sheetName).addMergedRegion(new CellRangeAddress(startRow,endRow,startColumn,endColumn));
		return new MergedCellConstraints(context,sheetName,startRow,startColumn,endRow,endColumn);
	}
...
//	public CellConstraints setBold(boolean bold){
//		CellStyle style=context.cloneCellStyle(sheetName, startRow, startColumn);
//		style.setFont(context.getFont(style.getFontIndex(),(short)size,bold,italic,underLine,deleteLine));
//	    context.setCellStyle(sheetName, startRow, startColumn,style);
//		return this;
//		style.setVerticalAlignment(alignment);
//	    context.setCellStyle(sheetName, startRow, startColumn,style);
